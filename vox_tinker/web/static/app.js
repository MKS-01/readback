// vox-tinker web client: getUserMedia → AudioWorklet (16k Int16) → WS → server
...
// SUPPORTED_MODELS in vox_tinker/stt/transcriber.py.
...
const PREFS_KEY = "vox-tinker.prefs.v8";
const THEMES = ["ghost"];
const defaultPrefs = {
  orbSize: 240,
  showMeter: true,
