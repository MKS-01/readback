"""FastAPI server exposing the vox-tinker pipeline over WebSocket.
...
from vox_tinker.memory import SessionWriter
from vox_tinker.stt.transcriber import Transcriber
from vox_tinker.stt.turn import TurnDetector, TurnDetectorUnavailable
from vox_tinker.tools import ClockTool, ToolRegistry, WebSearchTool
from vox_tinker.tools.web_search import build_default_provider
from vox_tinker.tts.synthesizer import (
    SUPPORTED_VOICE_NAMES,
    Synthesizer,
)
from vox_tinker.wakeword import WakeWordDetector, WakeWordUnavailable

log = logging.getLogger("vox_tinker.web")
    ...
    if cert_path is not None:
        ...
        async def download_cert():
            return FileResponse(
                ...
                headers={"Content-Disposition": "attachment; filename=vox-tinker.pem"},
            )
