...
from vox_tinker.config import WhisperConfig
...
class WhisperEngine:
    """faster-whisper / CTranslate2 backend (batch only). CPU int8 is the fast
    path on Apple Silicon — there is no MPS backend for CTranslate2."""
