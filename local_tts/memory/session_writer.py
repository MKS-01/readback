...
from local_tts.config import MemoryConfig, ObsidianConfig
from local_tts.memory.topic_classifier import UNSORTED, propose_topic

if TYPE_CHECKING:
    from local_tts.llm.client import LLMClient

log = logging.getLogger("local_tts.memory.writer")
